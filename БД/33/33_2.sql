...
INSERT Трамваи
(Номер_трамвая, номер_депо, модель, год_постройки, дата_капитального_ремонта,
количество_мест, количество_сидячих_мест, длина_трамвая, количество_тележек, количество_секций)

VALUES
(1, 1, ' М ', 2020, '01-01-2022', 245, 144, 125, 49, 1),
(2, 2, '"М!', 2007, '18-02-2008', 151, 115, 400, 37, 4),
(3, 3, '!М@', 2017, '13-11-2018', 245, 156, 499, 14, 1),
(4, 4, '*М-', 1993, '02-09-1995', 152, 115, 100, 41, 7),
(5, 5, 'ДДп314', 1995, '01-01-1999', 245, 100, 300, 161, 42),
(6, 6, 'ПИК9', 1990, '25-12-1999', 124, 125, 500, 41, 11),
(7, 7, '+М=', 2014, '11-10-2004', 299, 100, 800, 49, 8),
(8, 8, ' М ', 2017, '14-06-2018', 200, 145, 600, 49, 9),
(9, 9, 'Модель1', 2005, '21-05-2008', 99, 69, 700, 14, 14),
(10, 10, 'ЦК914', 2007, '19-05-2008', 245, 115, 1500, 49, 7),
(11, 11, '!М ', 2005, '19-05-2005', 243, 116, 150, 26, 2),
(12, 12, '-М!', 2000, '19-05-2008', 2415, 512, 1500, 76, 1);
